...
public class DepositActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 添加组件和设置参数
		back = (ImageButton) findViewById(R.id.deposit_title_btn_back);
		...
		bankDesc = bank.getBankName() + ":" + bank.getBankDesc();
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			if ((int) data.get("mood") == 0){
				...
				if (happyBi < Config.VIEW_BAD_MOOD_DEPOSIT){
					Toast.makeText(getApplicationContext(), "幸福币余额不足", Toast.LENGTH_SHORT).show();
					return ;
				} else {
