...
public class DepositDAO extends BaseDAO {
	...
	public Cursor QueryDepositByName(int bankID, String depositName) {
		String[] args = { String.valueOf(bankID) };
		return db.query("deposit", null, "depositname like '%" + depositName + "%'and bankid =?", args, null, null,
				null, null);
	}
	
	public Cursor QueryDepositByDepositID(int depositID) {
		String[] args = { String.valueOf(depositID) };
		return db.query("deposit", null, "depositid =?", args, null, null,
				null, null);
	}
	
	public Cursor QueryDepositByBankID(int bankID) {
		String[] args = { String.valueOf(bankID) };
		return db.query("deposit", null, "bankid = ?", args, null, null,
				null, null);
	}
